...
namespace FSI.CloudShopping.Infrastructure.Repositories
{
    public class OrderRepository : BaseRepository<Order>, IOrderRepository
    {
        ...
        protected override string ProcUpdate => "Procedure_Order_UpdateStatus"; // Geralmente só atualizamos status
        ...
        public async Task<IEnumerable<Order>> GetOrdersByCustomerIdAsync(int customerId)
        {
            ...
            using var reader = await cmd.ExecuteReaderAsync();
            while (await reader.ReadAsync()) orders.Add(MapToEntity(reader));
            return orders;
        }
